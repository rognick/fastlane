module Fastlane
  module Actions
    module SharedValues
      NR_OCLINT_REPORT_PATH = :NR_OCLINT_REPORT_PATH
    end

    class NrOclintAction < Action
      ...
      def self.run(params)
        ...
        # files.select! do |file|
        #   file_ruby = file.gsub('\ ', ' ')
        #   if (!exclude_regex or file_ruby !~ exclude_regex)
        #     UI.important("file_ruby: #{file_ruby}")
        #   end
        # end
        ...
        # UI.important("command_prefix: #{command_prefix}")
        ...
        Actions.lane_context[SharedValues::NR_OCLINT_REPORT_PATH] = File.expand_path(report_path)
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :enable_global_analysis,
                                       env_name: "NR_OCLINT_ENABLE_GLOBAL_ANALYSIS",
          ...
          FastlaneCore::ConfigItem.new(key: :allow_duplicated_violations,
                                       env_name: "NR_OCLINT_ALLOW_DUPLICATED_VIOLATIONS",
      ...
      def self.output
        [
          ['NR_OCLINT_REPORT_PATH', 'The reports file path']
        ]
      end
